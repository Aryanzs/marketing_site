...
const BlogSearchSection = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center bg-blue-50 px-4 md:px-8 lg:px-32 py-12 md:py-16 lg:py-24 rounded-lg max-w-full mx-auto">
