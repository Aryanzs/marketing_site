...
const BlogSearchSection = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center bg-blue-50 px-4 md:px-8 lg:px-32 py-20 md:py-16 lg:py-36 rounded-lg max-w-full mx-auto">
      ...
      <div className="flex flex-col items-center lg:items-start mb-8 lg:mb-0 lg:mr-8 text-center lg:text-left w-full lg:w-auto">
        ...
        <div className="relative mt-6 w-1/2 lg:w-[500px]">
          <input
            ...
            className="px-4 py-4 w-full rounded-lg border-2 border-gray-200 shadow-xl"
          />
        </div>

        {/* Search Button */}
        <div className="flex justify-center lg:justify-start mt-4">
          <button className="bg-red-500 text-white px-8 py-4 w-full  rounded-lg hover:bg-red-600 transition-colors shadow-lg ">
            SEARCH
          </button>
        </div>
      </div>
