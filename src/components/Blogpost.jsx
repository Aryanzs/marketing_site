              ...
              >
                ...
                {imageSrc0 && (
                  <img
                    ...
                    style={{ aspectRatio: "16/9" }} // Adds specific aspect ratio dynamically
                    src={imageSrc0}
                    alt="Article"
                  />
                )}
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mt-4 mb-2">
                    {new Date(blogPosts[1].date).toLocaleDateString()},{" "}
                    {blogPosts[1].author}
                  </p>
                </motion.div>
              );
            ...
            (() => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mt-4 mb-2">
                    {new Date(blogPosts[2].date).toLocaleDateString()},{" "}
                    {blogPosts[2].author}
                  </p>
                </motion.div>
              );
          ...
          (() => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-4">
                  {new Date(blogPosts[3].date).toLocaleDateString()},{" "}
                  {blogPosts[3].author}
                </p>
              </motion.div>
            );
